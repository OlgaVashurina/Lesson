...
который возвращает множество, содержащее только элементы, которые присутствуют в обоих исходных множествах
...
public class Task2 {
    ...
    private static <T> Set<T> difference(Set<T> set1, Set<T> set2) {
        // разность множеств (элементы, которые присутствуют в set1, но отсутствуют в set2)
        Set<T> result = new HashSet<>(set1);
